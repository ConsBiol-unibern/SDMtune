...
#' accessed via GBIF.org on 2019-02-12. Accessed from R via rgbif
...
#' Accessed from R via rgbif \url{(https://github.com/ropensci/rgbif)}.
#'
...
#' 2019-02-12. Accessed from R via rgbif
#' \url{(https://github.com/ropensci/rgbif)}.
#'
...
#' GBIF.org on 2019-02-12. Accessed from R via rgbif
#' \url{(https://github.com/ropensci/rgbif)}.
"condor"
