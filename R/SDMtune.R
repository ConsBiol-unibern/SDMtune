...
#' implementation through the "maxnet" package). All the functions used to
#' select variables or to tune model hyperparameters have an interactive
#' real-time chart that is displayed in the RStudio viewer pane during the
