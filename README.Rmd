...
The file **maxent.jar** can be downloaded [here](https://biodiversityinformatics.amnh.org/open_source/maxent/) (note that you need **MaxEnt** version >= 3.4.1 [@Phillips2017a]). This file must be copied into the right folder to be available for the `dismo` package [@Hijmans2017]: copy the file **maxent.jar** into the folder named **java** that is located inside the folder returned by the following command:
