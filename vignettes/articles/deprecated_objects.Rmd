...
For the following code we assume that you have one old `SWD()` object called **test_swd**:
```{r convert SWD test, eval=FALSE}
test <- old2NewSWD(test_swd)
```
