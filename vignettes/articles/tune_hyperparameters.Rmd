...
The best model was trained using 5000 background locations (we can select the same background locations with `exp_6@models[[1]]@a`), `lh` as feature class combination and a regularization multiplier equal to 0.8:
```{r final model}
