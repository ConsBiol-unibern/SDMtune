...
exp_6 <- randomSearch(model, hypers = h, metric = "auc", test = val, pop = 20, seed = 65651)
```
...
exp_7 <- optimizeModel(model, hypers = h, metric = "auc", test = val, pop = 20, gen = 5, keep_best = 0.4, keep_random = 0.2, mutation_chance = 0.4, seed = 65651)
```
