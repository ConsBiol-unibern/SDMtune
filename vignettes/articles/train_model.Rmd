...
### Try yourself
Try to change the default settings  and train a model using linear and hinge as feature combinations, 0.5 as regularization multiplier and 700 iterations. To see the solution highlight the next cell:
