...
As you can see the variables `bio1`, `bio16` and `bio6` have been removed, The output of the function is the model trained with the selected variables:
```{r output varSel}
...
In the next article you will learn how to tune the [model hyperparameters](./tune_hyperparameters.html).
