...
this return the AUC value averaged across the four different models. We can also plot the response curve of a `SDMmodelCV()` object but with **SDMtune** is not possible to make predictions:
