...
```{r predict train}
pred <- predict(default_model, data = train, type = "cloglog")
```
...
kable(thresholds(default_model, type = "cloglog")) %>%
...
plotPA(map, th = 0.306, filename = "my_pa_map", format = "GTiff")
```
