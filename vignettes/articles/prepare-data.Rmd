...
In this article you will learn how to prepare the data to train models using `SDMtune`. We will use the [virtualSp](../../reference/virtualSp.html) dataset included in the package and environmental predictors from the  [WorldClim](http://www.worldclim.org/) dataset.
