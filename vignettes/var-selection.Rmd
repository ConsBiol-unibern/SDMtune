---
title: "Variable selection with 'SDMtune'"
...
data <- prepareSWD(species = "Virtual species", p = virtualSp$presence, a = virtualSp$background, env = predictors, categorical = "biome")
...
```{r exercise 1}
selected_variables_model <- varSel(model, metric = "aicc", bg4cor = bg, method = "spearman", cor_th = 0.7, env = predictors, use_pc = TRUE)
```
