...
```{r run MaxEnt}
full_model <- runMaxent(train, bg_model, rm = 1, fc = 'lqph', test = val, output_format = 'cloglog', response_curves = TRUE, folder = 'full_model')
```
