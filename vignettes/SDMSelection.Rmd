...
```{r run MaxEnt}
full_model <- trainMaxent(presence = train, bg = bg_model, rm = 1, fc = 'lqph', test = val, maxent_output = 'cloglog', folder = 'full_model')
```
